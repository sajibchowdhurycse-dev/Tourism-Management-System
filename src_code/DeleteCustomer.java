...
public class DeleteCustomer extends JFrame {
    ...
    public DeleteCustomer() {
        ...
        // *************** LOAD IMAGE USING YOUR ABSOLUTE PATH ***************
        String imgPath = "C:\\Users\\User\\Desktop\\file\\Sajib python\\Travel Management System\\src\\icons\\delete.png";
        ...
        lblTitle.setBounds(118, 11, 350, 53);
        ...
        Conn conn = new Conn();
        try {
            ResultSet rs = conn.s.executeQuery("SELECT username FROM customer");
            while (rs.next()) {
        ...
        btnDelete.addActionListener((ActionEvent e) -> {
            ...
            Conn c = new Conn();
            try {
                int rows = c.s.executeUpdate("DELETE FROM customer WHERE username = '" + selectedUsername + "'");
                if (rows > 0) {
                    JOptionPane.showMessageDialog(this, "Customer Detail Deleted Successfully");
                    c1.removeItem(selectedUsername);
                    l2.setText(""); l3.setText(""); l4.setText("");
                    l5.setText(""); l6.setText(""); l7.setText("");
                    l8.setText(""); l9.setText("");
                }
            } catch (Exception ex) {
                ex.printStackTrace();
            }
        ...
        btnExit.addActionListener((ActionEvent e) -> setVisible(false));
